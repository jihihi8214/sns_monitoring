...
def summarize_text(text):
    ...
    prompt = (
        "다음은 정치인/공직자의 SNS 게시글이야. 이 글이 '무엇에 대한' 글인지 주제가 한눈에 보이도록 "
        "한국어 한 문장으로 압축해줘. '~했습니다/~합니다' 식으로 내용을 그대로 풀어 쓰지 말고, "
        "핵심 주제·대상·쟁점이 드러나는 제목/헤드라인 톤으로 써줘.\n"
        "예시: '형사재판의 유죄 증명 기준을 설명한 이건태 의원 글을 공유', "
        "'반도체 산업 지원 확대를 강조하는 발언', '제헌절을 맞아 헌법 정신을 강조'.\n"
        "원문을 그대로 인용하지 말고, 요약문만 출력해.\n\n"
        f"게시글:\n{text[:1500]}"
    )
